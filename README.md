...
1. When the authors submit a replication package at martin.monperrus@csc.kth.se,mendezfe@acm.org, the Open Science Chairs ask one member of the Open Science board to review the package.
