...
1. Once a manuscript gets "Minor revision" or "Acceptance", the decision email contains the following text:
    * "As you probably know already, EMSE encourages open science and reproducible research. We are happy to invite your to submit your open data, open material, or open source code (in the folllowing referred to as "replication package") for an additional, short, review by the open science board. Provided you agree to participate, the board will then review the replication package and check its eligibility to publicly recognised your open science effort with an open science badge and provide you with further constructive feedback on content and documentation of the package. Prior to sending the replication package for review, please revise the manuscript thoroughly considering also final feedback you might have received by the authors from the manuscript review and also kindly refer to emsejournal/openscience for further information on the open science initiative. This page also containts a list of Frequently Asked Questions for further guidance.  To submit your replication package, please send an email to emsejournal.openscience@gmail.com. Should you have any questions, please do not hesitate to contact the open science chairs Daniel Mendez and Martin Monperrus any time referring to the same email. Finally, please note that your decision to participate in our open science initiative will not affect the remaining reviewing and editorial process in any way."
